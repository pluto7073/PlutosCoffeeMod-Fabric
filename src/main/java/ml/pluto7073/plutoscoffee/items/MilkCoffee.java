...
public class MilkCoffee extends Item {
    public MilkCoffee() {
        super(new Item.Settings().recipeRemainder(Items.GLASS_BOTTLE).food(Coffee.CoffeeFood).maxCount(16).group(ItemGroup.FOOD));
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            ...
            if (user instanceof PlayerEntity player) {
                player.incrementStat(ModStats.DRINK_COFFEE);
            }
        }
